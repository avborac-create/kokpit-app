...
export default async function FinansSayfasi({
  searchParams,
}: {
  ...
  return (
    <div className="pt-3">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-white">Finans / Muhasebe</h1>
        <p className="mt-1 text-sm text-white/55">
          Bir müvekkil seçin — para trafiği ve tasnif kayıtları buradan yönetilir.
        </p>
      </div>
